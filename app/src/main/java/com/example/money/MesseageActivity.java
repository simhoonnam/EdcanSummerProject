...
public class MesseageActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void sendSMS() {
        ...
        if (smsNum.length() > 0 && smsText.length() > 0 && smsfor > 0) {
            ...
            Toast.makeText(MesseageActivity.this, "모두 입력해 주세요", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void sendSMS(String smsNumber, String smsText) {
        ...
        else Toast.makeText(MesseageActivity.this, "asdf", Toast.LENGTH_SHORT).show();
    }
